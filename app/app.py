...
NUM_CLASSES = 7
pakaianadat_classes = ["Pakaian Adat Bali", "Pakaian Adat Jawa Tengah", "Pakaian Adat Kalimantan Barat",
		       			"Pakaian Adat Papua", "Pakaian Adat Riau", "Pakaian Adat Sulawesi Selatan",
